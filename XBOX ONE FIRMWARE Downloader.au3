...
;####################################################################
;# XBOX ONE FIRMWARE X DRIVE UPDATER								                #
;#----------------------------------								                #
...
#include <AutoItConstants.au3>
#include <Inet.au3>
$TITLE = "XBOX ONE FIRMWARE Downloader"
$update_dir = @MyDocumentsDir&"\Xbox One FW"
...
EndIf
$filename = "OSU1.zip"
$boot = "C:\Users\Keith\Dropbox\Xbox One\boot\bootanim.dat"    ;Change this to your animation directory location
$bootx = "C:\Users\Keith\Dropbox\Xbox One\boot\x\bootanim.dat" ;Change this to your animation directory location
	...
	Select
		Case $iMsgBoxAnswer = 1 ;OK
			...
			if FileExists($update_zip) = 1 Then
				...
				EndIf
			Else
				MsgBox(0,"Error","path/file does not exist."&@CRLF&$update_zip)
			EndIf
